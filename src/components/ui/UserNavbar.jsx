...
const UserNavbar = () => {
  ...
  return (
    <div className="flex flex-row justify-around h-18 w-full lg:px-20 gap-20 py-4">
      <div className="text-2xl font-bold items-center flex gap-4">
        <Link to="/courses">
        <img
