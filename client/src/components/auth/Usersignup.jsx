    ...
    <div className="flex justify-center my-20">
      <div>
        ...
        className="flex flex-col gap-4">
          <Input label="Enter name" register={register} required />
          <Input label="Enter username" register={register} required />
        ...
        <div className="flex flex-row gap-4 my-4">
          <div>Already have account ? <Link to="/auth/signin" className="text-violet-400 font-bold">Sign Up</Link></div>
        </div>
      </div>
